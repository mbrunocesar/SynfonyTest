...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // Not Valid User
        if ($pathinfo === '/not-a-valid-user') {
            return array (  '_controller' => 'AppBundle\\Controller\\ErrorController::notValidAction',  '_route' => 'Not Valid User',);
        }
        ...
        if (0 === strpos($pathinfo, '/user')) {
            ...
            if (preg_match('#^/user/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'app_user_view')), array (  '_controller' => 'AppBundle\\Controller\\UserController::viewAction',));
            }
            not_app_user_view:
            ...
            if (rtrim($pathinfo, '/') === '/user') {
                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'app_user_insert');
                }
